...
import br.com.fiap.hackathon.adapter.presenter.dto.upload.UploadVideoRequest;
...
public class UploadVideoController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<String> uploadVideo(@RequestBody UploadVideoRequest uploadVideoRequest) {

        String originalName = uploadVideoRequest.getVideoFile().getOriginalFilename();
        ...
        try {
            ...
            uploadVideoRequest.getVideoFile().transferTo(tempFile.toFile());
            uploadVideoUseCase.uploadVideo(id, tempFile, uploadVideoRequest.getEmail());
